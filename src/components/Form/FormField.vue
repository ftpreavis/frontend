...
<template>
	<label class="font-medium text-gray-800 dark:text-gray-100">
		...
		<input v-else type="file" @change="onChange" class="w-full mt-2 px-3 py-2  bg-transparent outline-none border focus:border-blue-500 shadow-sm rounded-lg dark:border-gray-500 focus:dark:border-gray-100">
