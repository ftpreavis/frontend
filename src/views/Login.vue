		...
		<div v-if="!requires2FA" class="w-4/5 m-auto border p-4 flex flex-col mt-20 shadow-xl">
			...
			<div class="border flex flex-col p-4 space-y-3">
				...
				<button @click="googleConnect"
					class="py-2 px-5 border rounded text-orange-400 shadow-md cursor-pointer">Google</button>
				<button @click="normalLogout"
					class="py-2 px-5 border rounded text-orange-400 shadow-md cursor-pointer">delog</button>
				<button @click="googleLogout"
					class="py-2 px-5 border rounded text-orange-400 shadow-md cursor-pointer">delog google</button>
			</div>
		</div>
		<div v-if="requires2FA" class="w-4/5 m-auto border p-4 flex flex-col mt-20 shadow-xl">
